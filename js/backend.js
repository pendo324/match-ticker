...
function insertMatch(rad, dire, league_id, players, livein) {
	...
	if (typeof livein === 'undefined') {
		...
		$('#matches').append('<div class=\'row-fluid col-xs-10 col-md-10 col-md-offset-1 col-xs-offset-1\' style=\'outline: 1px solid orange;\'><h3 id=\'radiant\' col-md-12> <img src=\'' +
		tourney_logo + '\' class=\'img-responsive img-thumbnail\' />' + tourney_name + '</h3> <h4 class=\'col-md-offset-7 col-md-2 text-right\'><img src=\'' + 
		rad_logo + '\' class=\'img-responsive img-thumbnail\' /> ' + rad_name + '</h4> <h5 id=\'vs\' class=\'col-md-1 text-center\'>VS</h5>' +
